...
const DEFAULT_CATEGORIES = [
  { _id: 'c-coffee', name: 'Coffee', slug: 'coffee', icon: '☕' },
  { _id: 'c-tea', name: 'Tea', slug: 'tea', icon: '🍵' },
  { _id: 'c-burgers', name: 'Burgers', slug: 'burgers', icon: '🍔' },
  { _id: 'c-sandwiches', name: 'Sandwiches', slug: 'sandwiches', icon: '🥪' },
...
const DEFAULT_ITEMS = [
  { _id: 'item-c1', name: 'Classic Cappuccino', price: 149, category: { name: 'Coffee', slug: 'coffee', icon: '☕' }, description: 'Rich espresso topped with velvety steamed milk foam', isVeg: true, isBestseller: true, preparationTime: 5, tags: ['hot', 'classic', 'espresso'], imageUrl: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-c2', name: 'Café Latte', price: 159, category: { name: 'Coffee', slug: 'coffee', icon: '☕' }, description: 'Smooth espresso with creamy steamed milk', isVeg: true, isBestseller: false, preparationTime: 5, tags: ['hot', 'creamy'], imageUrl: 'https://images.unsplash.com/photo-1534778101976-62847782c213?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-c3', name: 'Cold Brew Coffee', price: 179, category: { name: 'Coffee', slug: 'coffee', icon: '☕' }, description: 'Slow-steeped cold brew, bold and refreshing', isVeg: true, isBestseller: true, preparationTime: 3, tags: ['cold', 'bold'], imageUrl: 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-c4', name: 'Caramel Macchiato', price: 199, category: { name: 'Coffee', slug: 'coffee', icon: '☕' }, description: 'Layered espresso, milk, and vanilla with caramel drizzle', isVeg: true, isBestseller: true, preparationTime: 5, tags: ['hot', 'sweet'], imageUrl: 'https://images.unsplash.com/photo-1485808191679-5f86510681a2?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-t1', name: 'Masala Chai', price: 79, category: { name: 'Tea', slug: 'tea', icon: '🍵' }, description: 'Traditional Indian spiced tea brewed with milk & ginger', isVeg: true, isBestseller: true, preparationTime: 5, tags: ['hot', 'desi'], imageUrl: 'https://images.unsplash.com/photo-1576092768241-dec231879fc3?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-b1', name: 'Classic Chicken Burger', price: 189, category: { name: 'Burgers', slug: 'burgers', icon: '🍔' }, description: 'Juicy crispy chicken patty with lettuce and mayo', isVeg: false, isBestseller: true, preparationTime: 12, tags: ['crispy', 'chicken'], imageUrl: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500&auto=format&fit=crop&q=60' },
  { _id: 'item-b2', name: 'Double Decker Beef Burger', price: 259, category: { name: 'Burgers', slug: 'burgers', icon: '🍔' }, description: 'Double beef patties loaded with cheddar cheese & BBQ sauce', isVeg: false, isBestseller: true, preparationTime: 15, tags: ['loaded', 'cheesy'], imageUrl: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=500&auto=format&fit=crop&q=60' },
        ...
        <div className="menu-controls flex flex-wrap gap-3 items-center justify-between">
          ...
          <form className="search-bar flex-1 min-w-[260px]" onSubmit={handleSearchSubmit} role="search">
            ...
            <input
              ...
              placeholder="Search by Trie prefix (e.g. espresso, burger, chai)..."
              value={searchInput}
