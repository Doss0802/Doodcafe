...
const categories = [
  { name: 'Coffee', slug: 'coffee', icon: '☕', displayOrder: 1 },
...
const getMenuItems = (catMap) => [
  ...
  {
    name: 'Café Latte',
    description: 'Smooth espresso with creamy steamed milk, a daily favourite',
    price: 159,
    category: catMap['coffee'],
  ...
  },
  {
    ...
    description: 'Slow-steeped cold brew, bold and refreshing',
    price: 179,
    category: catMap['coffee'],
    tags: ['cold', 'bold', 'refreshing'],
    isVeg: true,
    isBestseller: true,
    preparationTime: 3,
  },
  {
    ...
    description: 'Layered espresso, milk, and vanilla with caramel drizzle',
    price: 199,
    category: catMap['coffee'],
